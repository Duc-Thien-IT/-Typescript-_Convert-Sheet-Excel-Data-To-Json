...
import { processFirstSheet, processAllSheets } from '../controller/excelController';
 ...
 */
router.post('/upload-first-sheet', upload.single('file'), processFirstSheet);
 ...
 *         description: Error processing file
 */
router.post('/upload-all-sheets', upload.single('file'), processAllSheets);
